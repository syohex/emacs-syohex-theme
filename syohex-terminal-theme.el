...
(custom-theme-set-faces
 ...
 '(highlight ((t (:foreground "color-155" :background nil :underline t))))
 ...
 '(diff-refine-added ((t (:background unspecified :weight bold))))
 '(diff-refine-removed ((t (:background unspecified :weight bold))))
