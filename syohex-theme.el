...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "#ffdd99"))))
 '(font-lock-comment-delimiter-face ((t (:foreground "chocolate1"))))
 '(font-lock-comment-face ((t (:foreground "chocolate1"))))
 '(font-lock-constant-face ((t (:foreground "#b3b3ff"))))
 '(font-lock-doc-face ((t (:foreground "LightSalmon"))))
 '(font-lock-function-name-face ((t (:foreground "#ffdd99"))))
 '(font-lock-keyword-face ((t (:foreground "#dd99ff"))))
 ...
 '(eglot-semantic-class ((t (:foreground "#99ff99"))))
 ...
 '(eglot-semantic-function ((t (:foreground "#ffdd99"))))
 '(eglot-semantic-method ((t :foreground "#ffdd99")))
 ...
 '(eglot-semantic-variable ((t (:foreground "#b3f0ff"))))
 '(eglot-semantic-parameter ((t :foreground "#b3f0ff")))
